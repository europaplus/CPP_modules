...
/*   Updated: 2021/03/31 17:57:19 by knfonda          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Form::execute(Bureaucrat const &executor) const
{
	if (_signed)
	{
		if (_gradeToExecute <= executor.getGrade())
			...
			Form::GradeTooLowException("Grade cannot execute form because grade too low.");
	}
	else
	{
		std::cout << _name;
		throw Form::IfNotSigned(" not signed.");
	}
}
...
const char *Form::IfNotSigned::what() const throw()
{ return (IfNotSigned::_msg); }

Form::GradeTooHighException::~GradeTooHighException () throw() {};
Form::GradeTooLowException::~GradeTooLowException () throw() {};
Form::IfNotSigned::~IfNotSigned () throw() {};
